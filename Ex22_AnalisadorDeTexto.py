...
n = name.split() #Função split() divide todas as palavras separadas por espaço em uma lista e os agrupa em um único objeto(variável)
print(f'O seu primeiro nome tem {len(n[0])} letras') #Mostrando na tela do usuário o retorno do primeiro nome dele + a chamada da função upper() que deixa tudo em maiúsculo
